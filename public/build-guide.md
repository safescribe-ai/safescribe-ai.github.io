...
- **[docs/PI-SETUP-GUIDE.md](PI-SETUP-GUIDE.md)** – Step-by-step setup and troubleshooting.
- **[raspberry-pi/README.md](../raspberry-pi/README.md)** – One-command install, email setup, manual install from USB.
